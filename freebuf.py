...
import base64
from nntplib import *
from justposting import post2nntp
from datetime import datetime

import random
import string

rss_url = r'http://feed43.com/3742774642815111.xml'
newsgroup = r'cn.test'
...
for feed in feeds.entries:
    ...
    print itemlink
    itemparsedate = datetime.utcnow().timetuple()
    ...
    with open(directory + pubyday + pubhour + pubmin + pubsec + random.choice(string.ascii_letters) + extname, 'wb+') as f1:
        #header
...
post2nntp (directory, nntpserver, extname)